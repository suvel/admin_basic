  ...
  return (
    <div className="MultiRowAction">
      <div className="MultiRowAction_cation">
        <img src={alert_emoji} />
        <p>
          Review the rows that you have selected for removing, by clicking
          Delete you might not get the data back
        </p>
      </div>
      <div className="MultiRowAction_tableContainer">
        <Table data={selectedTableRow} />
      </div>
      <div className="MultiRowAction_action">
        <Button
          onClick={handelDeletingMultipleRows}
          type="outline"
          variant="alert"
        >
          Delete
